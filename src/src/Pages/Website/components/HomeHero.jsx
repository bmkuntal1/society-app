...
import heroImage from "/src/assets/images/tarang_hero.jpg";
                ...
                <div className="row gx-5 align-items-center">
                    <div className="col-xxl-5">
                        ...
                        <div className="text-center text-xxl-start">
                            ...
                            <div className="fs-3 fw-light text-muted text-end mb-5">यहाँ ख़ुशियाँ लाने की कोशिश है।</div>
                            <div className="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                <Link className="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" to="/anouncements">Anouncements</Link>
                        ...
                        <div className="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div className="profile bg-gradient-primary-to-secondary" >
                                <div className="profile-hero">
                                    <img className="profile-img" src={heroImage} alt="..." />
                                </div>
